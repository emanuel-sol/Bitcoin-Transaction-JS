...
var data = Buffer.from('Hello World', 'utf8'); // Message to be embedded in a BTC transaction
var testnet = bitcoin.networks.testnet; // Network
var privateKey = 'cQx4Ucd3uXEpa3bNnS1JJ84gWn5djChfChtfHSkRaDNZQYA1FYnr'; // private key in wallet import format
var SourceAddress = 'n3CKupfRCJ6Bnmr78mw9eyeszUSkfyHcPy'; // source address from which we spend Unspent Transaction Output
...
// Ask API to provide available UTXO belonging to dest addr
rp(options)
    .then(function (response) {
        ...
        var vout = response.data.txs[index].output_no; // index of UtxoId
        var amount = Number(response.data.txs[index].value * 100000000);
        var fee = 0.0005 * 100000000; // fee to pay network miners
        ...
        //For P2SH transaction use the following code instead the previous line.
        // Make sure that the source address is a P2SH address
